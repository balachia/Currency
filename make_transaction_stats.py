...
if re.match(r'corn..\.stanford\.edu',node()) or re.match(r'barley[^.]+\.stanford\.edu',node()) or re.match(r'yen[^.]+\.stanford\.edu',node()):    DATAFILE = expanduser('~/2YP/data/forexposition.h5')
